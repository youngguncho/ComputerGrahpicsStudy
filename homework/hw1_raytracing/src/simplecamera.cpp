...
//          zcop is at 2.5 along positive z axis
...
Ray SimpleCamera::ray(int i, int j)
{
  /*_invisible_*/
  Point pixel_pos(Xmin + (float)i*Width + Wo2, Ymin + (float)j*Height + Ho2, 0.0);

  Ray ray;
  Point cop(0.0, -0.25, Zcop);
